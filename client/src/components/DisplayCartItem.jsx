    ...
    return (
        <section className='bg-neutral-900 fixed top-0 bottom-0 right-0 left-0 bg-opacity-70 z-50'>
            <div className='bg-white w-full max-w-sm min-h-screen max-h-screen ml-auto'>
                ...
                <div className='min-h-[75vh] lg:min-h-[80vh] h-full  max-h-[calc(100vh-130px)] bg-blue-50 p-2 flex flex-col'>
                    {/* display items */}
                    {
                        cartItem[0] ? (
                            <>
                            ...
                            <div className='bg-white flex flex-col justify-center items-center'>
                                ...
                                <Link onClick={close} to={'/'} className='block bg-green-500 px-4 py-2 hover:bg-green-600 text-white rounded'>Shop Now</Link>
                            </div>
                        )
                    }
                ...
                </div>
                {
                    cartItem[0] && (
                        <div className='p-2'>
                            ...
                            <div className='bg-green-700 text-white p-4 sticky font-bold text-base bottom-3 rounded flex items-center gap-4 justify-between'>
                                <div>
