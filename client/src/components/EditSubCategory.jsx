                ...
                <form action="" className='my-3 grid gap-3' onSubmit={handleSubmitSubCategory}>
                    ...
                    <div className='grid gap-1'>
                        ...
                        <div className='flex flex-col lg:flex-row items-center gap-3'>
                            ...
                            <label htmlFor="uploadSubCategoryImage">
                                <div className='px-4 py-1 border border-primary-100
                                 text-primary-200 rounded hover:bg-primary-200 hover:text-neutral-900 cursor-pointer'>
                                    Upload Image
                                </div>
                                <input type="file"
                    ...
                    <div className='grid gap-1'>
                        ...
                        <div className='border focus-within:border-primary-200 rounded'>
                            ...
                            {/* select category */}
                            <select className='w-full p-2 bg-transparent outline-none border' name="" id=""
                                onChange={(e) => {
                    ...
                    <button className={`px-4 py-1 border ${subCategoryData?.name && subCategoryData?.image && subCategoryData?.category[0] ? 'bg-primary-200 text-neutral-900 hover:bg-primary-300' : 'bg-neutral-200 text-neutral-400 cursor-not-allowed'} rounded`}>
                        Submit
                    </button>
