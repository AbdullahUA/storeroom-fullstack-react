                ...
                <section>
                    ...
                    <div className='grid p-3'>
                        <form action="" className=' grid gap-4' onSubmit={handleSubmit}>
                                    ...
                                    <select className='bg-blue-50 border w-full p-2 rounded'
                                        ...
                                        <option value={""}>Select Category</option>
                                        {
                                            allCategory.map((c, index) => {
                                                return (
                                                    <option key={c+index+'allcategory'} value={c?._id}>{c.name}</option>
                                                )
                                            })
                                        }
                                    ...
                                    <select className='bg-blue-50 border w-full p-2 rounded'
                                        ...
                                        <option value={""}>Select SubCategory</option>
                                        {
                                            allSubCategory.map((c, index) => {
                                                return (
                                                    <option key={c.name+index} value={c?._id}>{c.name}</option>
                                                )
                                            })
                                        }
                            ...
                            <button className='bg-primary-100 hover:bg-primary-200 py-2 rounded font-semibold'>Update Product</button>
